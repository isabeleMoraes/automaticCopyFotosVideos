...
from service.duplicateImageService import findImages
from tkinter import *
...
class Application:
    def __init__(self, master=None):
        ...
        self.titulo = Label(self.primeiroContainer, text="Buscar fotos duplicadas")
        ...
        self.botaoCopiar["text"] = "Verificar Fotos"
...
root = Tk()
root.title("Busca de fotos duplicadas - Created By Isabele Moraes")
Application(root)
root.mainloop()